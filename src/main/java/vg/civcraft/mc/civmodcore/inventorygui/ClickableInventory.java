...
public class ClickableInventory {
     ...
     * @param name name of the inventory which is shown at the top when a player has it open
     */
     ...
     *
     * @param size Size of the inventory to create, must be multiple of 9, bigger than 0 and smaller than 54
     * @param name name of the inventory which is shown at the top when a player has it open
     */
     ...
     *
     * @param index index of the Clickable or the item representation in the inventory
