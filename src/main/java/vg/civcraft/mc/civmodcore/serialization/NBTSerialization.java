...
public final class NBTSerialization {
    ...
    public static <T extends NBTSerializable> void registerNBTSerializable(Class<T> clazz, String... aliases) {
        ...
        if (!hasValidConstructor) {
            throw new IllegalArgumentException(
                    "Cannot register NBTSerializable: " + "the given class has no public, zero parameter constructor.");
        }
        if (registeredClasses.containsKey(clazz.getName())) {
            throw new IllegalArgumentException(
                    "Cannot register NBTSerializable: " + "the given class is already registered.");
        }
    ...
    public static NBTSerializable deserialize(NBTCompound nbt) {
        ...
        try {
            ...
            throw new NBTSerializationException("NBTSerializable[" + clazz.getName() + "] could not be deserialized.",
                    exception);
        }
    }
