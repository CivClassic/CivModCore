...
public class NBTCompound implements Cloneable {
    ...
    public NBTCompound clone() throws CloneNotSupportedException {
        ...
        clone.tag = (NBTTagCompound) this.tag.clone();
        return clone;
    }
    ...
    public boolean getBoolean(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that boolean: the key is null or empty.");
    ...
    public void setBoolean(@Nonnull String key, boolean value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that boolean: the key is null or empty.");
    ...
    public boolean[] getBooleanArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that boolean array: the key is null or empty.");
    ...
    public byte getByte(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that byte: the key is null or empty.");
    ...
    public void setByte(@Nonnull String key, byte value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that byte: the key is null or empty.");
    ...
    public byte[] getByteArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that byte array: the key is null or empty.");
    ...
    public short getShort(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that short: the key is null or empty.");
    ...
    public void setShort(@Nonnull String key, short value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that short: the key is null or empty.");
    ...
    public short[] getShortArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that short array: the key is null or empty.");
    ...
    public int getInteger(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that integer: the key is null or empty.");
    ...
    public void setInteger(@Nonnull String key, int value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that integer: the key is null or empty.");
    ...
    public int[] getIntegerArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that integer array: the key is null or empty.");
    ...
    public long getLong(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that long: the key is null or empty.");
    ...
    public void setLong(@Nonnull String key, long value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that long: the key is null or empty.");
    ...
    public long[] getLongArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that long array: the key is null or empty.");
    ...
    public float getFloat(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that float: the key is null or empty.");
    ...
    public void setFloat(@Nonnull String key, float value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that float: the key is null or empty.");
    ...
    public float[] getFloatArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that float array: the key is null or empty.");
    ...
    public double getDouble(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that double: the key is null or empty.");
    ...
    public void setDouble(@Nonnull String key, double value) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot set that double: the key is null or empty.");
    ...
    public double[] getDoubleArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that double array: the key is null or empty.");
    ...
    public UUID getUUID(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that UUID: the key is null or empty.");
    ...
    public String[] getStringArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that String array: the key is null or empty.");
    ...
    public NBTCompound getCompound(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that tag compound: the key is null or empty.");
    ...
    public NBTCompound[] getCompoundArray(@Nonnull String key) {
        Preconditions.checkArgument(!Strings.isNullOrEmpty(key), "Cannot get that tag compound array: the key is null or empty.");
    ...
    public static NBTCompound fromItem(@Nonnull ItemStack item) {
        ...
        if (craftItem == null) {
            throw new IllegalArgumentException("Cannot get the NBTCompound to that item: cannot convert to CraftItemStack.");
        }
    ...
    public static ItemStack toItem(@Nonnull ItemStack item, @Nonnull NBTCompound nbt) {
        ...
        net.minecraft.server.v1_12_R1.ItemStack craftItem = CraftItemStack.asNMSCopy(item);
        if (craftItem == null) {
            throw new IllegalArgumentException("Cannot set the NBTCompound to that item: cannot convert to CraftItemStack.");
        }
    ...
    public static ItemStack processItem(ItemStack item, Consumer<NBTCompound> processor) {
        if (item == null) {
            throw new IllegalArgumentException("Cannot process that item's NBT: the item is null.");
        }
        if (processor == null) {
            throw new IllegalArgumentException("Cannot process that item's NBT: the processor is null.");
        }
        net.minecraft.server.v1_12_R1.ItemStack craftItem = CraftItemStack.asNMSCopy(item);
        if (craftItem == null) {
            throw new IllegalArgumentException("Cannot process that item's NBT: item cannot be manipulated.");
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Cannot process that item's NBT: processing failed.", exception);
        }
        craftItem.setTag(nbt.tag);
        return CraftItemStack.asBukkitCopy(craftItem);
    }
     ...
     * @return Returns an NBTCompound if the deserialization was successful.
     *
     * @throws IllegalArgumentException Throws if the given data is null or empty, or if there was an error during the
    ...
    public static NBTCompound fromBytes(byte[] bytes) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Cannot deserialize that NBT data: data not intelligible.", exception);
        }
        return nbt;
    }
     ...
     * @return Returns a data array representing the given NBTCompound if the serialization was successful.
     *
     * @throws IllegalArgumentException Throws if the given NBTCompound is null, or if there was an error during the
    ...
    public static byte[] toBytes(NBTCompound nbt) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Cannot serialize that NBT data.", exception);
        }
