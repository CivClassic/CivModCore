...
public class IntegerSetting extends PlayerSetting<Integer> {
    ...
    public IntegerSetting(JavaPlugin owningPlugin, Integer defaultValue, String name, String identifier, ItemStack gui, String description, boolean showAmountInGui) {
