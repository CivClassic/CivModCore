...
public class BoundedIntegerSetting extends IntegerSetting {
    ...
    public BoundedIntegerSetting(JavaPlugin owningPlugin, int defaultValue, String name, String identifier, ItemStack gui, String description, boolean showAmountInGui, int lowerBound, int upperBound) {
