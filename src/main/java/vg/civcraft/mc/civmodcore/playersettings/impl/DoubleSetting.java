...
public class DoubleSetting extends PlayerSetting<Double> {
    ...
    public DoubleSetting(JavaPlugin owningPlugin, Double defaultValue, String name, String identifier, ItemStack gui, String description) {
        this(owningPlugin, defaultValue, name, identifier, gui, description, 2);
    }

    public DoubleSetting(JavaPlugin owningPlugin, Double defaultValue, String name, String identifier, ItemStack gui, String description, int decimalPointsVisible) {
