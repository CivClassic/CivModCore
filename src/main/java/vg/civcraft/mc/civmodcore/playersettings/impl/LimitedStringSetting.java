...
public abstract class LimitedStringSetting extends StringSetting {
    ...
    public LimitedStringSetting(JavaPlugin plugin, String defaultValue, String name, String identifier, ItemStack gui, String description, Collection<String> validValues, boolean caseSensitive) {
