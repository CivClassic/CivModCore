...
public class ListSetting<T> extends AbstractCollectionSetting<List<T>, T> {
    ...
    public ListSetting(JavaPlugin owningPlugin, List<T> defaultValue, String name, String identifier, ItemStack gui, String description, Class<T> elementClass) {
    ...
    public ListSetting(JavaPlugin owningPlugin, String name, String identifier, ItemStack gui, String description, Class<T> elementClass) {
