...
public class FloatSetting extends PlayerSetting<Float> {
    ...
    public FloatSetting(JavaPlugin owningPlugin, Float defaultValue, String name, String identifier, ItemStack gui, String description) {
        this(owningPlugin, defaultValue, name, identifier, gui, description, 2);
    }

    public FloatSetting(JavaPlugin owningPlugin, Float defaultValue, String name, String identifier, ItemStack gui, String description, int decimalPointsVisible) {
