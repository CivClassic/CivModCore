...
public class SetSetting<T> extends AbstractCollectionSetting<Set<T>, T> {
    ...
    public SetSetting(JavaPlugin owningPlugin, Set<T> defaultValue, String name, String identifier, ItemStack gui, String description, Class<T> elementClass) {
    ...
    public SetSetting(JavaPlugin owningPlugin, String name, String identifier, ItemStack gui, String description, Class<T> elementClass) {
