...
public class DecimalFormatSetting extends PlayerSetting<DecimalFormat> {
    ...
    public DecimalFormatSetting(JavaPlugin owningPlugin, DecimalFormat defaultValue, String name, String identifier, ItemStack gui, String description, double exampleValue) {
