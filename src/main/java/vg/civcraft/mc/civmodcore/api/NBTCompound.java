...
public class NBTCompound implements Cloneable {
    ...
    public boolean[] getBooleanArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that boolean array; the key is null or empty.");
    ...
    public void setBooleanArray(@Nonnull String key, @Nonnull boolean[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that boolean array; the key is null or empty.");
    ...
    public byte[] getByteArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that byte array; the key is null or empty.");
    ...
    public void setByteArray(@Nonnull String key, @Nonnull byte[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that byte array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public short[] getShortArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that short array; the key is null or empty.");
    ...
    public void setShortArray(@Nonnull String key, @Nonnull short[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that short array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public int[] getIntegerArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that integer array; the key is null or empty.");
    ...
    public void setIntegerArray(@Nonnull String key, @Nonnull int[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that integer array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public long[] getLongArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that long array; the key is null or empty.");
    ...
    public void setLongArray(@Nonnull String key, @Nonnull long[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that long array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public float getFloat(@Nonnull String key) {
        Preconditions.checkArgument(StringUtils.isNotEmpty(key), "Cannot get that float; the key is null or empty.");
    ...
    public void setFloat(@Nonnull String key, float value) {
        Preconditions.checkArgument(StringUtils.isNotEmpty(key), "Cannot set that float; the key is null or empty.");
    ...
    public float[] getFloatArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that float array; the key is null or empty.");
    ...
    public void setFloatArray(@Nonnull String key, @Nonnull float[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that float array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public double[] getDoubleArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that double array; the key is null or empty.");
    ...
    public void setDoubleArray(@Nonnull String key, @Nonnull double[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that double array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public void setString(@Nonnull String key, @Nonnull String value) {
        ...
        Preconditions
                .checkNotNull(value, "Cannot set that String; the value is null. Please use .remove(key) instead.");
    ...
    public String[] getStringArray(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that String array; the key is null or empty.");
    ...
    public void setStringArray(@Nonnull String key, @Nonnull String[] values) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that String array; the key is null or empty.");
        Preconditions.checkNotNull(values,
    ...
    public NBTCompound getCompound(@Nonnull String key) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot get that tag compound; the key is null or empty.");
    ...
    public void setCompound(@Nonnull String key, @Nonnull NBTCompound value) {
        Preconditions
                .checkArgument(StringUtils.isNotEmpty(key), "Cannot set that tag compound; the key is null or empty.");
