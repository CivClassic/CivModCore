...
public final class EnchantingAPI {
    ...
    private EnchantingAPI() {
    } // Make the class effectively static
     ...
     * @see EnchantingAPI#isSafeEnchantment(Enchantment, int)
     */
    public static boolean addEnchantment(@Nonnull ItemStack item, @Nonnull Enchantment enchantment, int level, boolean onlyAllowSafeEnchantments) {
