...
public final class Iteration {
	 ...
	 */
	public static <T> int arrayLength(final T[] array) {
	 ...
	 */
	public static <T> int collectionSize(final Collection<T> collection) {
	 ...
	 */
	@SafeVarargs
	public static <T> boolean contains(final T base, final T... values) {
	 ...
	 */
	public static <T> void iterateThenClear(final Collection<T> collection, final Consumer<T> processor) {
	 ...
	 * @param processor The iteration processor which will be called for each item in the collection.
	 */
	public static <T> void iterateHasNext(final Collection<T> collection, final ElementAndBoolConsumer<T> processor) {
		if (isNullOrEmpty(collection) || processor == null) {
			return;
		}
	 ...
	 */
	@SafeVarargs
	public static <T> void addAll(final Collection<T> collection, final T... values) {
