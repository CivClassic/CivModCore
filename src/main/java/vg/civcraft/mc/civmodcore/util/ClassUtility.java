            ...
            if (pack == null) {
                ...
                for (ClassPath.ClassInfo info : path.getTopLevelClassesRecursive(packageName)) {
                    ...
                    try {
                        ...
                        plugin.info("CivModCore failed to load class {0}, you could be missing a dependency. This message is" + " more of an info message useful for debugging. If you see this message you can usually " + "ignore it unless the plugin itself throws an error.", info.getName());
                        continue;
                    }
