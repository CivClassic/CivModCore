...
public abstract class TableBasedBlockChunkMeta<D extends TableBasedDataObject> extends BlockBasedChunkMeta<TableBasedDataObject, TableStorageEngine<D>> {
            ...
            for (int j = 0; j < l2Cache.length; j++) {
                ...
                for (int k = 0; k < l3Cache.length; k++) {
                    ...
                    for (int l = 0; l < l4Cache.length; l++) {
                        if (l4Cache[l] != null) {
                            @SuppressWarnings("unchecked") D value = (D) l4Cache[l];
