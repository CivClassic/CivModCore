...
public class Tester {
    ...
    public void testByteSerialization() {
        ...
        // Test if the stored data on the newly created compound matches what is
        // expected to be there.
        assertEquals(secondNBT.getString(testStringKey), testString);
    }
    ...
    public void testNullSerialization() {
        ...
        // Test if the stored data on the newly created compound matches what is
        // expected to be there.
        assertNull(secondNBT.getString(testStringKey));
        assertArrayEquals(secondNBT.getStringArray(testStringArrayKey), testStringArray);
    }
